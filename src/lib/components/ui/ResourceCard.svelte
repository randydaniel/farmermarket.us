...
<div class="group w-full max-w-[364px]">
	...
	>
		...
		<!-- Overlay on hover -->
		<div
			class="pointer-events-none absolute inset-0 z-10 bg-slate-950/50 opacity-0 transition-opacity duration-300 group-focus-within:opacity-100 group-hover:opacity-100"
		></div>
		<!-- Buttons on hover -->
		<div
		...
		>
			<button
				type="button"
				class="pointer-events-auto flex items-center gap-2 rounded-full bg-slate-950 px-4 py-2 text-sm font-medium text-slate-50 shadow transition hover:bg-slate-800 focus:ring-2 focus:ring-slate-950 focus:ring-offset-2 focus:outline-none"
			...
			<button
				type="button"
				class="pointer-events-auto flex h-9 w-9 items-center justify-center rounded-full bg-slate-950 text-slate-50 shadow transition hover:bg-slate-800 focus:ring-2 focus:ring-slate-950 focus:ring-offset-2 focus:outline-none"

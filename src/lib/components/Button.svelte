...
<button
	{type}
	class={`inline-flex w-fit items-center gap-2 rounded-full px-3 py-2 font-medium transition-all duration-300 hover:cursor-pointer focus:ring-2 focus:ring-offset-2 focus:outline-none
